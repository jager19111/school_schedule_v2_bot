                ...
                for lesson in lessons:
                    await db.execute('''
                        ...
                        (id, date, period_id, class_id, lesson_num, group_id, 
                         subject_id, teacher_id, room_id, is_exchange, is_cancelled, 
                    ...
                    ''', (
                        ...
                        lesson.group_id, lesson.subject_id, lesson.teacher_id, lesson.room_id, 
                        int(lesson.is_exchange), int(lesson.is_cancelled), lesson.id, lesson.id
                    ))
                await db.commit()
